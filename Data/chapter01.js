  ...
  documents: [
    {
      ...
      sections: [
        ...
        { heading: "배치 기록", text: "관찰석 B 식별자는 <b>OBS-14/B</b>다. 마지막 정식 배치자는 [[P-003|P-003 정수민]]이며, 전근 후 비어 있다. 현재 사용자가 앉아 있는 자리는 B석이다." },
    ...
    },
    {
      ...
      sections: [
        ...
        { heading: "현장 메모 발췌", text: "03:16 — N-04 보관함을 쓰는 기록 보조 <b>S.N.</b>이 수기 노트를 요청. 03:17 이후 인원 확인 불가. 콘솔에 사람 이름이 아닌 식별자가 뜸.", quote: true },
    ...
    },
    {
      ...
      sections: [
        ...
        { heading: "L-017 대조 로그", text: "I-014 당일 L-017 콘솔 영상은 <b>03:17:00–03:17:13</b> 구간이 비어 있다. 영상 복구 뒤 인증 로그에는 03:17:13에 세션 <b>R-14/ARCHIVE</b>가 생성된 것으로 남았다. 이 식별자는 유효 직원 계정이나 출입 배지와 일치하지 않는다." },
